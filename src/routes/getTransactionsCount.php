...
$app->post('/api/Paybook/getTransactionsCount', function ($request, $response) {
    ...
    $optionalParams = ['idTransaction'=>'id_transaction','idAccount'=>'id_account','idCredential'=>'id_credential','idSite'=>'id_site','idSiteOrganization'=>'id_site_organization','idSiteOrganizationType'=>'id_site_organization_type','isDisable'=>'is_disable','hasAttachment'=>'has_attachment','dtRefreshFrom'=>'dt_refresh_from','dtRefreshTo'=>'dt_refresh_to','dtTransactionFrom'=>'dt_transaction_from','dtTransactionTo'=>'dt_transaction_to','keywords'=>'keywords','skipKeywords'=>'skip_keywords'];
    $bodyParams = [
       'query' => ['id_account','token','has_attachment','id_transaction','dt_refresh_from','dt_refresh_to','dt_transaction_from','dt_transaction_to','id_credential','id_site','id_site_organization','id_site_organization_type','is_disable','keywords','skip_keywords']
    ];
    ...
    $query_str = "https://sync.paybook.com/v1/transactions/count";
